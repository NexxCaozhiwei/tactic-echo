...
local function copyAutoBurstDiagnostics()
    ...
    return {
        ...
        lastInjectionPreflight = {
            ...
            firstExcludedCooldownSource = preflight.firstExcludedCooldownSource,
            firstExcludedActionSlot = asNumber(preflight.firstExcludedActionSlot),
            firstExcludedActionBarStateTrusted = preflight.firstExcludedActionBarStateTrusted == true,
            firstExcludedActionBarNumericReady = preflight.firstExcludedActionBarNumericReady == true,
            firstExcludedDirectActionBarReadyEvidence = preflight.firstExcludedDirectActionBarReadyEvidence == true,
            firstExcludedActionBarReadyConflict = preflight.firstExcludedActionBarReadyConflict == true,
            firstExcludedActionBarReadyConflictReason = preflight.firstExcludedActionBarReadyConflictReason,
            cooldownEdgePending = preflight.cooldownEdgePending == true,
            cooldownEdgeStepKey = preflight.cooldownEdgeStepKey,
            cooldownEdgeSpellID = asNumber(preflight.cooldownEdgeSpellID),
            cooldownEdgeActionSlot = asNumber(preflight.cooldownEdgeActionSlot),
            cooldownUncertain = preflight.cooldownUncertain == true,
            dispatchAttempt = asNumber(preflight.dispatchAttempt),
            temporaryUsabilityDeferred = preflight.temporaryUsabilityDeferred == true,
            deferredTemporaryCount = asNumber(preflight.deferredTemporaryCount),
            firstDeferredTemporarySpellID = asNumber(preflight.firstDeferredTemporarySpellID),
            firstDeferredTemporaryReason = preflight.firstDeferredTemporaryReason,
            deferredTemporaryOrder = preflight.deferredTemporaryOrder,
            deferredCooldownCount = asNumber(preflight.deferredCooldownCount),
            deferredFutureOptionalCount = asNumber(preflight.deferredFutureOptionalCount),
            firstDeferredCooldownSpellID = asNumber(preflight.firstDeferredCooldownSpellID),
            deferredCooldownOrder = preflight.deferredCooldownOrder,
        },
        resolvedRule = {
            id = rule.id,
            source = rule.source,
        ...
        plan = {
            ...
            admittedOwnReady = plan.admittedOwnReady == true,
            ...
            preWindowCaptureCooldownEdgePending = plan.preWindowCaptureCooldownEdgePending == true,
            preWindowCaptureCooldownEdgeStepKey = plan.preWindowCaptureCooldownEdgeStepKey,
            preWindowCaptureCooldownEdgeSpellID = asNumber(plan.preWindowCaptureCooldownEdgeSpellID),
            preWindowCaptureCooldownEdgeActionSlot = asNumber(plan.preWindowCaptureCooldownEdgeActionSlot),
            preWindowCaptureCooldownEdgeBudgetSeconds = asNumber(plan.preWindowCaptureCooldownEdgeBudgetSeconds),
            ...
            candidateOfferCount = asNumber(plan.candidateOfferCount),
            matchingFailureCount = asNumber(plan.matchingFailureCount),
            failureExcludedByTemporaryUnavailable = plan.failureExcludedByTemporaryUnavailable == true,
            failureObservedMoving = plan.failureObservedMoving == true,
            movementRetryHold = plan.movementRetryHold == true,
            configuredSequenceLength = asNumber(plan.configuredSequenceLength),
            deferredTailCount = asNumber(plan.deferredTailCount),
            deferredTailInitialCount = asNumber(plan.deferredTailInitialCount),
            deferredTailAdmittedCount = asNumber(plan.deferredTailAdmittedCount),
            deferredTailExpiredCount = asNumber(plan.deferredTailExpiredCount),
        ...
        lastStepObservation = {
            ...
            phase = step.phase,
            reason = step.reason,
            temporaryUnavailable = step.temporaryUnavailable == true,
            temporaryUnusableIgnoredForMovement = step.temporaryUnusableIgnoredForMovement == true,
            playerMoving = step.playerMoving == true,
            actionUsable = step.actionUsable,
            spellUsable = step.spellUsable,
            actionSlotUsable = step.actionSlotUsable,
            ...
            cooldownActionBarReadyConflict = step.cooldownActionBarReadyConflict == true,
            cooldownActionBarReadyConflictReason = step.cooldownActionBarReadyConflictReason,
