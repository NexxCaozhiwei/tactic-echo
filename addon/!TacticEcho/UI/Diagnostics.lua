...
local function printMacroDiagnostics(bindingInfo)
    ...
    safePrint("宏候选诊断：槽位=" .. tostring(diag.slot)
        ...
        .. " actionInfoId=" .. tostring(diag.actionInfoValue or diag.actionInfoId or "无")
        .. " macroIndex=" .. tostring(diag.actionInfoMacroIndex or "无")
        .. " index形式=" .. tostring(diag.actionInfoLooksLikeMacroIndex == true)
        .. " 代表SpellID=" .. tostring(diag.representedSpellID or "无")
        ...
        .. " 候选=" .. tostring(diag.semanticCandidateCount or 0)
        .. "/" .. tostring(diag.actionTextCandidateCount or 0)
    ...
    if diag.macroName or diag.resolvedMacroIndex or diag.resolvedBodyLength
        ...
        safePrint("宏候选详情：宏=" .. tostring(diag.macroName or diag.getMacroInfoByActionInfoIdName or "未知")
            ...
            .. " 候选索引=" .. tostring(diag.semanticCandidateIndexes or "无")
