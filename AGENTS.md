# AGENTS.md — Tactic Echo 1.5.4 开发与安全边界
...
- HUD 底部蓝色状态行中，主推荐已通过安全校验时显示 `HAD`；HUD 按钮自身不得把 dispatchable 状态改写为 `HAD`，按钮状态/tooltip fallback 仍沿用原有“可用/推荐/施法/引导”等语义。
